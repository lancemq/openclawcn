...
const docsReadingOrder = [
  ...
  '/docs/getting-started/personal-user-entry',
  '/docs/getting-started/developer-team-entry',
  '/docs/getting-started/enterprise-ops-entry',
  ...
  '/docs/manual/feishu-qr-login-and-drive-comments',
  ...
  '/docs/manual/searxng-search-provider',
  ...
  '/docs/operations/long-session-governance',
