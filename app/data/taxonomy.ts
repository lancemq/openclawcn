...
export const topicDefinitions: TopicDefinition[] = [
  ...
  },
  {
    slug: 'channels',
    title: '渠道接入',
    description: '围绕 Telegram、WhatsApp、飞书、WebChat 等入口，帮助判断什么时候该接渠道、什么时候该先验证系统。',
  ...
  },
  {
    ...
    description: '适合已经跑通基础链路，准备判断 Skills、Tools、Hooks、插件和自动化分别该在什么时候进入。',
  ...
  },
  {
    slug: 'providers',
    title: '模型提供商',
    description: '围绕 provider 认证、默认模型、fallback 以及国内 provider 与本地模型的组合方式。',
  ...
  },
  {
    slug: 'models',
    title: '模型与本地推理',
    description: '围绕模型选择、国内 provider、Ollama / vLLM 和本地推理补位策略。',
  ...
  },
  {
    slug: 'security',
    title: '安全与权限',
    description: '覆盖认证、暴露面、allowlist、Tailscale / SSH，以及中文部署教程里最容易忽略的安全边界。',
...
export const learningPaths = [
  {
    ...
    summary: '先理解产品，再完成安装与 Onboarding，最后确认 Gateway、Dashboard 和最小聊天链路。',
    steps: [
  ...
  },
  {
    ...
    summary: '先判断现在是否真的该接渠道，再确认登录方式、入口边界和第一次稳定接入顺序。',
    steps: [
  ...
  },
  {
    ...
    summary: '优先用更稳的 Windows / WSL 安装顺序跑通链路，再进入安全与升级检查。',
    steps: [
  ...
  },
  {
    ...
    summary: '先把 Skills、Tools、Hooks、插件的边界理清，再进入更实战的扩展方法。',
    steps: [
  ...
  },
  {
    ...
    summary: '先理解网络模型和配对，再选择 SSH / tailnet / Tailscale Serve 等远程路径，最后进入多 Gateway 隔离。',
    steps: [
  ...
  },
  {
    ...
    summary: '先理解 Gateway 架构和安全边界，再建立升级、监控、反馈和长期治理闭环。',
    steps: [
