...
export default defineEventHandler(async (event) => {
  ...
  const urls: SitemapUrl[] = [
    ...
    { loc: toAbsoluteUrl(siteUrl, '/tools'), changefreq: 'weekly', priority: '0.8' },
    { loc: toAbsoluteUrl(siteUrl, '/tools/plugins'), changefreq: 'weekly', priority: '0.7' },
    { loc: toAbsoluteUrl(siteUrl, '/tools/triggers'), changefreq: 'weekly', priority: '0.7' },
    { loc: toAbsoluteUrl(siteUrl, '/tools/automation'), changefreq: 'weekly', priority: '0.7' },
    { loc: toAbsoluteUrl(siteUrl, '/tools/diagnostics'), changefreq: 'weekly', priority: '0.7' },
    ...
    { loc: toAbsoluteUrl(siteUrl, '/ecosystem'), changefreq: 'weekly', priority: '0.7' },
    { loc: toAbsoluteUrl(siteUrl, '/derivatives'), changefreq: 'weekly', priority: '0.7' },
    { loc: toAbsoluteUrl(siteUrl, '/secondary-development'), changefreq: 'weekly', priority: '0.7' },
    ...
    { loc: toAbsoluteUrl(siteUrl, '/security'), changefreq: 'weekly', priority: '0.8' },
    { loc: toAbsoluteUrl(siteUrl, '/showcase'), changefreq: 'weekly', priority: '0.7' },
    { loc: toAbsoluteUrl(siteUrl, '/updates'), changefreq: 'weekly', priority: '0.6' },
    { loc: toAbsoluteUrl(siteUrl, '/story'), changefreq: 'monthly', priority: '0.5' },
    ...
    { loc: toAbsoluteUrl(siteUrl, '/privacy'), changefreq: 'yearly', priority: '0.2' },
    { loc: toAbsoluteUrl(siteUrl, '/terms'), changefreq: 'yearly', priority: '0.2' },
    { loc: toAbsoluteUrl(siteUrl, '/disclaimer'), changefreq: 'yearly', priority: '0.2' },
    ...docs.map((item) => ({
      loc: toAbsoluteUrl(siteUrl, String(item.path || '')),
      lastmod: String(item.updatedAt || ''),
      changefreq: 'monthly',
      priority: '0.7',
    })),
    ...news.map((item) => ({
      loc: toAbsoluteUrl(siteUrl, String(item.path || '')),
      lastmod: String(item.updatedAt || item.date || ''),
      changefreq: 'daily',
      priority: '0.8',
    })),
