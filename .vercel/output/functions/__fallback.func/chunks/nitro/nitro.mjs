...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "e18506bf-da3f-4037-b6e8-74124ef84fbc",
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/bestPractices/sql_dump.txt": {
        "prerender": true
      },
      "/_nuxt/builds/meta/**": {
        "headers": {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/maqi/code/openclawcn/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "ipx": {
...
const _VBihmX = eventHandler(async (event) => {
...
const checksums = {
  "docs": "v3.5.0--NHXjFi8xyZlWvTxqUHpC1Zmmj8vd_fzKw7XuTxJcH4k",
  "news": "v3.5.0--Vps6gabWr_fAUDLkpYIrwbYAEJXtlmvLuD3E-9QvvhU",
  "bestPractices": "v3.5.0--jkklrXjyCcC9OSWXR1KM9apz6RnFOapeJI21s7RJcPY"
};
const checksumsStructure = {
  "docs": "Gi1RUX7KIFQv1Zy3PDGgmYOfuHDwqNAfZ6EK6xg2z3k",
  "news": "8_2pWdAabKk4szNGIV1VCnEHLWU1hH04V1uv8-EOry4",
  "bestPractices": "oEqTjdMh47IosiCxcrOfAfdcvKTzAB2NgFcctpvvoSM"
};
const tables = {
  "docs": "_content_docs",
  "news": "_content_news",
  "bestPractices": "_content_bestPractices",
  "info": "_content_info"
};
...
const _tjtRZG = eventHandler(async (event) => {
...
const _bc8g6q = lazyEventHandler(() => {
...
const _lazy_0bO_s1 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_0bO_s1, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/docs/sql_dump.txt', handler: _VBihmX, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/news/sql_dump.txt', handler: _VBihmX, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/bestPractices/sql_dump.txt', handler: _VBihmX, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _VBihmX, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/docs/query', handler: _tjtRZG, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/news/query', handler: _tjtRZG, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/bestPractices/query', handler: _tjtRZG, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _tjtRZG, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _bc8g6q, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_0bO_s1, lazy: true, middleware: false, method: undefined }
];
